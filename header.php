        ...
        <div class="header">
			<div class="header-left">
				<a href="index.php" class="logo">
					<img src="assets/img/logo2.png" width="35" height="35" alt=""> <span>MyWeb</span>
				</a>
			</div>
            ...
            <ul class="nav user-menu float-right">
                ...
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                        <span class="user-img"><img class="rounded-circle" src="assets/img/doctor-thumb-06.jpg" width="40" alt="Admin">
							<span class="status online"></span></span>
                        <span>Ayoub rachik</span>
                    </a>
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        <li class="menu-title">Bonjour Docteur &#10084;</li>
                        <li id='title' >
                            <a href="index.php"><i class="fa fa-dashboard"></i> <span>Tableau de bord</span></a>
                        </li>
                        ...
                        <li id='medicament' >
                            <a href="medicament.php"><i class="fa fa-calendar"></i> <span>Médicament</span></a>
                        </li>
                        <li id='ordonnances' >
                            <a href="ordonnances.php"><i class="fa fa-calendar-check-o"></i> <span>Ordonnances</span></a>
                        </li>
                        <li id='factures'>
                            <a href="factures.php"><i class="fa fa-money"></i> <span>Factures</span></a>
                        </li>
                        <li id='employes'>
                            <a href="employes.php"><i class="fa fa-user"></i> <span>Employés</span></a>
                        </li>

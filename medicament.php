...
<script>
    ...
    medicament.classList.add("active");
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Médicament</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-medicament.php" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Ajouter Médicament</a>
                    </div>
                </div>
				<div class="row">
					<div class="col-md-12">

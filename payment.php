								...
								<tbody>
											...
											<?php while($row1=mysqli_fetch_array($result1)) {?>
												...
												<tr clicable >
													...
													<td style='text-align: center; direction: ltr;' data-href="edit-demande.php?id=<?php echo $row1['idPatient'] ?>" ><?php echo $row1['tele'] ?></td>
													<td style='text-align: center;' data-href="edit-demande.php?id=<?php echo $row1['idPatient'] ?>"><?php echo $row1['date_n'] ?></td>
													<td style='text-align: center;' data-href="edit-demande.php?id=<?php echo $row1['idPatient'] ?>">Beni Mellal</td>

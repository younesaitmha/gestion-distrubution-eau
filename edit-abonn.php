...
<div onload="switchMUt()" class="page-wrapper">
    <div class="dem-table" class="content">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      <h4>أيوب رشيق</h4>
                      <p style="direction: rtl;" class="text- mb-1">+212673392085</p>
            ...
            <div class="col-md-8">
                         ...
                         <div class="card-body">
                          <ul class="nav nav-tabs">
                              <li class="nav-item">
                                  <a class="nav-link active "  href="">  معلومات شخصية</a>
                              </li>
                              <li class="nav-item">
                                  <a class="nav-link " href="#">فواتير</a>
                              </li>
                              <li class="nav-item">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                                ...
                                                <select id="sexe" name="sexe" class="form-control ">
                                                  <option value="homme" <?php if($row_patient['sexe'] =='Homme') echo 'selected' ?> >ذكر</option>
                                                  <option value="femme" <?php if($row_patient['sexe'] =='Femme') echo 'selected' ?> >اثى</option>
                                                </select>
                                    </div>
                                </div>
                </div>
                ...
                <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>CIN </label>
                                        <input value="<?php echo $row_patient['CIN'] ?>" id="cin" name="cin"  class="form-control rtl" type="text">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
